 ...
 *       &lt;sequence>
 *         &lt;element name="logEntries" type="{http://www.modelbus.org/Repository/}RepositoryLogEntry" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetLogEntriesResponse {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-11-17T09:23:46+01:00", comments = "JAXB RI v2.2.5")
    protected List<RepositoryLogEntry> logEntries;
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-11-17T09:23:46+01:00", comments = "JAXB RI v2.2.5")
    public List<RepositoryLogEntry> getLogEntries() {
        if (logEntries == null) {
            logEntries = new ArrayList<RepositoryLogEntry>();
        }
