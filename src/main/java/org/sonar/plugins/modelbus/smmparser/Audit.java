 ...
 * <ul>
 *   <li>{@link org.sonar.plugins.modelbus.smmparser.Audit#getMeasure <em>Measure</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.sonar.plugins.modelbus.smmparser.SoftwareMetricsMetamodel2Package#getAudit()
 * @model
 * @generated
 */
public interface Audit extends SMMNamedElement {
   ...
   * @see org.sonar.plugins.modelbus.smmparser.SoftwareMetricsMetamodel2Package#getAudit_Measure()
   * @model
   * @generated
   */
