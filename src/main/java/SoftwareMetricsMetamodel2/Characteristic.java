 ...
 * <ul>
 *   <li>{@link SoftwareMetricsMetamodel2.Characteristic#getMeasure <em>Measure</em>}</li>
 * </ul>
 * </p>
 *
 * @see SoftwareMetricsMetamodel2.SoftwareMetricsMetamodel2Package#getCharacteristic()
...
public interface Characteristic extends SMMNamedElement {
   ...
   * @see SoftwareMetricsMetamodel2.SoftwareMetricsMetamodel2Package#getCharacteristic_Measure()
