 ...
 * <ul>
 *   <li>{@link SoftwareMetricsMetamodel2.impl.RankingIntervalImpl#getMaximumEndpoint <em>Maximum Endpoint</em>}</li>
 *   <li>{@link SoftwareMetricsMetamodel2.impl.RankingIntervalImpl#isMaximumOpen <em>Maximum Open</em>}</li>
 *   <li>{@link SoftwareMetricsMetamodel2.impl.RankingIntervalImpl#getMinimumEndpoint <em>Minimum Endpoint</em>}</li>
 *   <li>{@link SoftwareMetricsMetamodel2.impl.RankingIntervalImpl#isMinimumOpen <em>Minimum Open</em>}</li>
 *   <li>{@link SoftwareMetricsMetamodel2.impl.RankingIntervalImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RankingIntervalImpl extends SMMElementImpl implements RankingInterval {
   ...
   */
    ...
    return SoftwareMetricsMetamodel2Package.Literals.RANKING_INTERVAL;
  }
