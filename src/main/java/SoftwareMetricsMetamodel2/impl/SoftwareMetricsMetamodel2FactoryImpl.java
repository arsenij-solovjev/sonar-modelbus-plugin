...
public class SoftwareMetricsMetamodel2FactoryImpl extends EFactoryImpl implements SoftwareMetricsMetamodel2Factory {
   ...
   */
    ...
    return createAccumulatorFromString(SoftwareMetricsMetamodel2Package.Literals.ACCUMULATOR, initialValue);
  }
   ...
   */
    ...
    return convertAccumulatorToString(SoftwareMetricsMetamodel2Package.Literals.ACCUMULATOR, instanceValue);
  }
