 ...
 * <ul>
 *   <li>{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#getAccumulator <em>Accumulator</em>}</li>
 *   <li>{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#isIsBaseSupplied <em>Is Base Supplied</em>}</li>
 *   <li>{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#getBaseMeasurement <em>Base Measurement</em>}</li>
 * </ul>
 * </p>
 *
 * @see SoftwareMetricsMetamodel2.SoftwareMetricsMetamodel2Package#getCollectiveMeasurement()
...
public interface CollectiveMeasurement extends DimensionalMeasurement {
   ...
   * The literals are from the enumeration {@link SoftwareMetricsMetamodel2.Accumulator}.
   * <!-- begin-user-doc -->
	 * <p>
   ...
   * @see SoftwareMetricsMetamodel2.SoftwareMetricsMetamodel2Package#getCollectiveMeasurement_Accumulator()
   ...
   */
	...
	/**
   * Sets the value of the '{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#getAccumulator <em>Accumulator</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Unsets the value of the '{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#getAccumulator <em>Accumulator</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see #isSetAccumulator()
   * @see #getAccumulator()
   ...
   */
	...
	/**
   * Returns whether the value of the '{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#getAccumulator <em>Accumulator</em>}' attribute is set.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   */
	 ...
	 * <!-- end-user-doc -->
   	 ...
   	 * @see SoftwareMetricsMetamodel2.SoftwareMetricsMetamodel2Package#getCollectiveMeasurement_IsBaseSupplied()
	...
	/**
   	 * Sets the value of the '{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#isIsBaseSupplied <em>Is Base Supplied</em>}' attribute.
   	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
   	 * Unsets the value of the '{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#isIsBaseSupplied <em>Is Base Supplied</em>}' attribute.
   	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   	 * @see #isSetIsBaseSupplied()
   	 * @see #isIsBaseSupplied()
	...
	/**
   	 * Returns whether the value of the '{@link SoftwareMetricsMetamodel2.CollectiveMeasurement#isIsBaseSupplied <em>Is Base Supplied</em>}' attribute is set.
   	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
   	 	 ...
   	 	 * @see SoftwareMetricsMetamodel2.SoftwareMetricsMetamodel2Package#getCollectiveMeasurement_BaseMeasurement()
